...
def test_add_multiple_subordinate() -> None:
    c = Citizen(1, 'Citizen 1', 3001, 'Big boss', 10)
    c1 = Citizen(9, 'Citizen 11', 3011, 'Watcher', 25)
    c2 = Citizen(5, 'Citizen 11', 3011, 'Watcher', 25)
    c3 = Citizen(10, 'Citizen 11', 3011, 'Watcher', 25)
    c.add_subordinate(c1)
    c.add_subordinate(c2)
    c.add_subordinate(c3)
    assert c.get_direct_subordinates()[0] is c2 and \
           c.get_direct_subordinates()[1] is c1 and \
           c.get_direct_subordinates()[2] is c3
    assert c1.get_superior() is c and c2.get_superior() is c and \
           c3.get_superior() is c
...
def test_become_subordinate_to_none() -> None:
    c = None
    c1 = Citizen(11, 'Citizen 11', 3011, 'Watcher', 25)
    c1.become_subordinate_to(c)
    assert c1.get_superior() is None
...
def test_get_citizen_in_the_middle() -> None:
    ...
    who = c3.get_citizen(2)
    assert [who.cid, who.manufacturer, who.model_year, who.job, who.rating] == \
           [2, "Hookins National Lab", 3024, "Manager", 30]
...
def test_get_all_subordinates_empty() -> None:
    c1 = Citizen(10, "Starky Industries", 3024, "Labourer", 50)
    c2 = Citizen(2, "Hookins National Lab", 3024, "Manager", 30)
    c3 = Citizen(3, "S.T.A.R.R.Y Lab", 3010, "Commander", 60)
    result = c3.get_all_subordinates()
...
def test_get_all_subordinates_multiple() -> None:
    c1 = Citizen(10, "Starky Industries", 3024, "Labourer", 50)
    c2 = Citizen(2, "Hookins National Lab", 3024, "Manager", 30)
    c3 = Citizen(3, "S.T.A.R.R.Y Lab", 3010, "Commander", 60)
    c9 = Citizen(9, "S.T.A.R.R.Y Lab", 3010, "Commander", 60)
    c4 = Citizen(4, "S.T.A.R.R.Y Lab", 3010, "Commander", 60)
    c17 = Citizen(17, "S.T.A.R.R.Y Lab", 3010, "Commander", 60)
    c1.become_subordinate_to(c2)
    c17.become_subordinate_to(c2)
    c9.become_subordinate_to(c3)
    c4.become_subordinate_to(c1)
    c2.become_subordinate_to(c3)
    result = c3.get_all_subordinates()
    assert result == [c2, c4, c9, c1, c17]
