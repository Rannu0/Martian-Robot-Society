...
main_window = Tk()
main_window.title("Martian Robot Society Hierarchy")
...
# Citizen model year
citizen_model_year_label = Label(main_window, text="    Start Year", anchor=W)
...
# Citizen Job
citizen_salary_label = Label(main_window, text="    Position",
                             anchor=W)
...
common_superior_btn = Button(main_window, text="Find common manager",
...
citizen_name_label = Label(main_window, text="Basic Controls",
                           anchor=W)
citizen_name_label.grid(column=5, row=0, columnspan=2, sticky=NSEW)

# View society head button
view_head_btn = Button(main_window, text="View President",
...
find_job_btn = Button(main_window,
                      text="Find citizen with position",
...
current_society_label = Label(main_window, text="Citizen relationships",
